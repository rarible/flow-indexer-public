...
dependencies {
    ...
    implementation("com.rarible.protocol:flow-protocol-api-nft:2.0.1-SNAPSHOT")
    implementation("com.rarible.protocol:flow-protocol-api-nft-order:2.0.1-SNAPSHOT")
    implementation("com.rarible.protocol:flow-protocol-api-order:2.0.1-SNAPSHOT")
    implementation("com.rarible.protocol:flow-api:2.0.1-SNAPSHOT")

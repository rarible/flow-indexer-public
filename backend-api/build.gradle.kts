...
dependencies {
    ...
    implementation("com.rarible.protocol:flow-protocol-model-common:2.0.3-SNAPSHOT")
    ...
    implementation("com.rarible.protocol:flow-protocol-api-nft:2.0.3-SNAPSHOT")
    implementation("com.rarible.protocol:flow-protocol-api-nft-order:2.0.3-SNAPSHOT")
    implementation("com.rarible.protocol:flow-protocol-api-order:2.0.3-SNAPSHOT")
    implementation("com.rarible.protocol:flow-api:2.0.3-SNAPSHOT")
